(function() {
    ...
    angular
        ...
        .controller('ProfesorListadoCreditosCubiertosController', ProfesorListadoCreditosCubiertosController);

        ProfesorListadoCreditosCubiertosController.$inject = ['$state', 'AsignaturaProfesor' , 'Asignatura', 'entity', 'ParseLinks', 'AlertService', 'paginationConstants', 'pagingParams'];

    function ProfesorListadoCreditosCubiertosController($state, AsignaturaProfesor, Asignatura, entity, ParseLinks, AlertService, paginationConstants, pagingParams) {
