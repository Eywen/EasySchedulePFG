(function() {
    ...
    angular
        ...
        .controller('AsignaturasCreditosSuperadosListadoController', AsignaturasCreditosSuperadosListadoController);

        AsignaturasCreditosSuperadosListadoController.$inject = ['$state', 'AsignaturaProfesor' , 'Asignatura', 'entity', 'ParseLinks', 'AlertService', 'paginationConstants', 'pagingParams'];

    function AsignaturasCreditosSuperadosListadoController($state, AsignaturaProfesor, Asignatura, entity, ParseLinks, AlertService, paginationConstants, pagingParams) {
